...
Start-Transcript -Path "$Path_local\Log\OneDriveDownloads-uninstall.log" -Force -Append
...
if ($downloadsPath -like "*OneDrive - JCS Solutions LLC*") {
    ...
    Write-Error "Downloads path is not configured for OneDrive"
}
